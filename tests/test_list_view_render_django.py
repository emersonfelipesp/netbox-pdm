...
_REQUIRE_DJANGO = os.environ.get("NETBOX_PDM_REQUIRE_DJANGO", "").lower() in (
    "1",
    "true",
    "yes",
)
...
_PLUGIN_MODULE_PREFIX = "netbox_pdm"
...
_MINIMUM_EXPECTED_LIST_VIEWS = 2
...
def _registered_plugin_list_views() -> tuple[tuple[str, type[ObjectListView]], ...]:
    ...
    importlib.import_module("netbox_pdm.urls")
